...
# ============================================================
# Elixir Stress Test — macOS Setup Script
# ============================================================
...
#
# Usage:
#   ./setupMac.sh           # Full install + start
#   ./setupMac.sh --start   # Skip install, just start services
#   ./setupMac.sh --stop    # Stop everything
#   ./setupMac.sh --status  # Check what's running
# ============================================================
...
echo "║                                              ║"
echo "║  Stop:  ./setupMac.sh --stop                  ║"
echo "║  Status: ./setupMac.sh --status               ║"
echo "║                                              ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
